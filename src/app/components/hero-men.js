...
export default function HeroWorkoutForMen() {
  ...
  return (
    ...
    <section className="w-full bg-[#f5f5f5] dark:bg-[#121212] transition duration-500" ref={ref}>
      ...
      ></div>
      <main className="flex flex-col justify-between p-64 items-center lg:p-64 md:py-96 tersembunyi-fade sm:py-80 sm:px-6 py-72 px-6 z-10 w-full h-full relative">
        <div id="hero-left">
          <div
