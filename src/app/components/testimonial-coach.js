...
const TestimonialsCoach = ({ testimonials }) => {
      ...
      <div className="mb-9 transition-all tersembunyi-fade duration-150 delay-300 ease-in-out">
        <div className="relative flex flex-col" ref={testimonialsRef}>
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="lg:text-2xl text-sm md:text-lg font-bold text-slate-900 before:content-['\201C'] after:content-['\201D']">{testimonial.quote}</div>
            </Transition>
          ))}
        </div>
      </div>
...
export default TestimonialsCoach;
