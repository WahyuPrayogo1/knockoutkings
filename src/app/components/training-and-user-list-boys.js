...
const BoysTrainingMatchList = () => {
    ...
    return (
        ...
        <div className="dark:text-white text-black flex flex-row uppercase gap-2 md:text-6xl text-4xl justify-center text-center py-8 transition duration-500" style={{fontFamily: 'Bebas Neue'}}>arrange your boys training match schedule</div>
        <p className="text-center dark:text-white text-black font-medium md:text-base text-sm leading-relaxed px-6 pb-8 transition duration-500 max-w-7xl mx-auto" style={{fontFamily: 'Roboto'}}>Our intensive 5-day training program designed to provide you with comprehensive knowledge and skills in Martial Arts. This program is scheduled to run from Monday to Friday, and it's an excellent opportunity to enhance your expertise and advance your Martial Arts skill, each day has 6 training programs you can choose them by your favorite. Once you choose one of them the training will appear at your training list.</p>
