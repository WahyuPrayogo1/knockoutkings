...
export default function Team() {
    ...
    return (
        <section id="gallery" className="pb-16 z-10 bg-[#f5f5f5] px-6 lg:px-12 -mt-2.5 w-full dark:bg-[#121212] transition duration-500">

        <div className="dark:text-white text-black transition duration-500 flex flex-row uppercase gap-2 lg:text-6xl text-4xl justify-center py-8" style={{fontFamily: 'Bebas Neue'}}>Meet our<h3>team</h3></div>
        <p className="text-center lg:text-base md:text-sm text-xs dark:text-white text-black transition duration-500 font-medium mx-auto leading-relaxed px-6 max-w-7xl" style={{fontFamily: 'Roboto'}}>The heart of Knockout Kings is our dedicated team of professional trainers and staff who bring a wealth of experience and knowledge to the gym. They are passionate about boxing and are committed to helping you achieve your goals. Whether you're interested in improving your boxing skills, getting in shape, or just having fun while working out, our team is here to guide you.</p>

            <div className="flex flex-col justify-center mt-10 gap-6 items-center">
            ...
            <div className="dark:text-white transition duration-500 uppercase gap-2 lg:text-6xl text-center text-4xl mt-20 py-4" style={{fontFamily: 'Bebas Neue'}}>We're Hiring!</div>
            <p className="text-center dark:text-white lg:text-md text-sm transition duration-500 mb-6 font-semibold" style={{fontFamily: 'Roboto'}}>Join our team and make a difference in the boxing comunity.</p>
            <Link href='/hiring' className="flex justify-center"><button style={{fontFamily: 'Roboto'}} className="md:px-4 md:py-2 px-2 py-1 md:text-md text-sm outline-red-600 hover:text-white outline dark:text-white hover:outline-none hover:bg-red-600 font-medium hover:font-semibold transition duration-500">Open position</button></Link>
        </section>
    )
}