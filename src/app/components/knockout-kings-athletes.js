...
export default function GalleryAthletes() {
    ...
    return (
        ...
        <section id="gallery" className="z-10 -mt-2.5 lg:px-12 px-6 pb-6 w-full bg-[#f5f5f5] dark:bg-[#121212] transition duration-500" ref={ref}>
            ...
            <div id="tittle" className="dark:text-white text-black tersembunyi-fade text-center uppercase md:text-6xl text-4xl py-8 transition duration-500" style={{fontFamily: 'Bebas Neue'}}>knockout kings athletes</div>
            <p id="tittle" className="text-center tersembunyi-fade dark:text-white text-black font-medium transition duration-500" style={{fontFamily: 'Roboto'}}>These are the athletes from Knockout Kings who are succeed to become world champions.</p>
            <div className="mx-auto px-5 py-2 lg:px-12 lg:pt-1 lg:my-8">
            <div className="dark:text-white tersembunyi-fade text-black uppercase lg:text-5xl text-4xl justify-center py-4 transition duration-500 text-center" style={{fontFamily: 'Bebas Neue'}}>boxing athletes </div>
            ...
            <div className="dark:text-white tersembunyi-fade text-black text-center uppercase lg:text-5xl text-3xl py-4 transition duration-500" style={{fontFamily: 'Bebas Neue'}}>mma athletes</div>
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 py-4 lg:gap-6 gap-4 max-w-7xl mx-auto">
