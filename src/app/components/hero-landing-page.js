...
export default function HeroLandingPage({ OpenModal }) {
    return (
        <section className="w-full relative">   
            ...
            <main className="flex flex-col lg:flex-row pt-24 lg:pt-0 justify-between px-6 lg:px-12 items-center z-10 max-w-7xl mx-auto">
                <div id="hero-left" className="lg:-mt-[150px] lg:max-w-md">
                ...
                <div id="hero-right" className="flex gap-4 pt-[100px] lg:max-w-2xl">
                    <div className="flex flex-col gap-2 pt-[200px]">
                        <div id="hero left" className="relative overflow-hidden bg-no-repeat shadow-black h-48 md:w-24 lg:w-full w-full shadow-xl group">
                    ...
                    <div className="flex flex-col gap-2 pt-[80px]">
                        <div id="hero left" className="relative overflow-hidden bg-no-repeat shadow-black h-48 md:w-24 lg:w-full w-full shadow-xl group">
                        ...
                        <div id="hero left" className="relative overflow-hidden bg-no-repeat shadow-black h-64 md:w-24 lg:w-full shadow-xl group">
                    ...
                    <div className="flex flex-col gap-2">
                        <div id="hero left" className="relative overflow-hidden bg-no-repeat shadow-black h-80 md:w-24 lg:w-full shadow-xl group">
