...
export default function ArticleMikeTyson() {
    ...
    return (
        ...
        <div id="tittle" className="dark:text-white transition duration-500 text-black text-center uppercase lg:text-6xl text-4xl justify-center py-8 max-w-4xl mx-auto" style={{fontFamily: 'Bebas Neue'}}>mike tyson is the new world champion</div>
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between px-6 py-4 max-w-7xl mx-auto">
            ...
            <div id="hero-landing-right" className="flex tersembunyi-hero justify-center w-full text-black dark:text-white transition duration-500">
